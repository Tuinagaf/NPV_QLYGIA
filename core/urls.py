...
urlpatterns = [
    ...
    path('api/proposals/<int:pk>/update/', views.api_update_proposal, name='api_update_proposal'),
    path('api/proposals/<int:pk>/delete/', views.api_delete_proposal, name='api_delete_proposal'),
    path('api/proposals/<int:pk>/undo/', views.api_undo_proposal, name='api_undo_proposal'),
